...
namespace MasterCRM.Infrastructure.Migrations
{
    ...
    [Migration("20240524205914_alphaBuildMigration")]
    partial class alphaBuildMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.GlobalStyles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cc19ec4a-5494-4cc9-afc1-0a4c56fb6831"),
                        ...
                        new
                        {
                            Id = new Guid("2302ab52-6d61-4313-8967-a4616e6ffeac"),
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.TextSection", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("620e7468-edfc-4c17-8229-1d99ca711c1d"),
                            MultipleTextBlockId = new Guid("b50cc534-2ffc-40e9-84b6-8cb9756a8cce"),
                            Text = "Каждое украшение создается вручную, что гарантирует его неповторимость и эксклюзивность.",
                            Title = "Уникальность изделий"
                        },
                        new
                        {
                            Id = new Guid("bf962c65-bd64-46a7-ac84-c4b7ad298188"),
                            MultipleTextBlockId = new Guid("b50cc534-2ffc-40e9-84b6-8cb9756a8cce"),
                        ...
                        new
                        {
                            Id = new Guid("992d10c7-8ba4-4618-ad5d-77698333acea"),
                            MultipleTextBlockId = new Guid("b50cc534-2ffc-40e9-84b6-8cb9756a8cce"),
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.CatalogBlock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8eacd1c0-cbb8-4fc8-b217-925e9229febb"),
                            Order = (short)2,
                            TemplateId = 1,
                            Title = "Каталог",
                            Type = 0
                        ...
                        new
                        {
                            Id = new Guid("460d3c0a-45d0-4774-b278-09185fe82185"),
                            Order = (short)2,
                            TemplateId = 2,
                            Title = "Каталог",
                            Type = 0
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.FooterBlock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("eab9cdd0-c2ae-4441-b99d-3caf4da61b64"),
                            Order = (short)5,
                            TemplateId = 1,
                        ...
                        new
                        {
                            Id = new Guid("1477c345-c7e4-4787-bfcf-c3de11ccfd5c"),
                            Order = (short)5,
                            TemplateId = 2,
                            Title = "Свяжитесь со мной",
                            Type = 0
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.H1Block", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2d4e3b18-eb9e-4af4-af60-4bbe8f0b9d29"),
                            Order = (short)1,
                            TemplateId = 1,
                            Title = "",
                        ...
                        new
                        {
                            Id = new Guid("aa47b955-7737-475a-89db-74607753176c"),
                            Order = (short)1,
                            TemplateId = 2,
                            Title = "",
                            H1Text = "H1 text",
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.HeaderBlock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d9873b20-54f0-4ada-bd5e-2aa2b77625ff"),
                            Order = (short)0,
                            TemplateId = 1,
                            Title = "",
                            Type = 0
                        ...
                        new
                        {
                            Id = new Guid("c1cf4f5a-8981-4866-8d86-1552e0139970"),
                            Order = (short)0,
                            TemplateId = 2,
                            Title = "",
                            Type = 0
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.MultipleTextBlock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b50cc534-2ffc-40e9-84b6-8cb9756a8cce"),
                            Order = (short)3,
                            TemplateId = 1,
                            Title = "Преимущества"
                        });
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.TextBlock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("987a6515-69e3-48ed-beda-52c227bfe965"),
                            Order = (short)4,
                            TemplateId = 2,
