...
namespace MasterCRM.Infrastructure.Migrations
{
    ...
    [Migration("20240516203705_globalStylesMigration")]
    partial class globalStylesMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.GlobalStyles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("36b3d58e-043d-401c-9c6f-b0c299bac0c6"),
                        ...
                        new
                        {
                            Id = new Guid("163f9e6c-7f8f-4587-83b0-d954c016e450"),
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.CatalogBlock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c6643412-e90a-4586-81e7-16a20354b2c8"),
                            Order = (short)3,
                            TemplateId = 1,
                            Type = 0
                        },
                        new
                        {
                            Id = new Guid("32f629ac-0f9c-4923-bcb1-29b3f386e810"),
                            Order = (short)3,
                            TemplateId = 2,
                            Type = 0
                        });
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.FooterBlock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3b79e44a-8945-4582-b110-724aecf6cc42"),
                            Order = (short)4,
                            TemplateId = 1,
                            Type = 0
                        },
                        new
                        {
                            Id = new Guid("da68a473-a320-4f52-82d8-c68dcb1a3de6"),
                            Order = (short)4,
                            TemplateId = 2,
                            Type = 0
                        });
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.H1Block", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b671aed6-7b93-4faa-8bcf-1de44d983485"),
                            Order = (short)1,
                            TemplateId = 1,
                            H1Text = "H1 text",
                        ...
                        new
                        {
                            Id = new Guid("bfee1f82-b5c4-4b93-9f5c-4d7da64a714d"),
                            Order = (short)1,
                            TemplateId = 2,
                            H1Text = "H1 text",
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.HeaderBlock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c343fbc1-63d6-4fa4-b3dc-d5520bcaa10d"),
                            Order = (short)0,
                            TemplateId = 1,
                            Type = 0
                        },
                        new
                        {
                            Id = new Guid("c0f7971c-0ba3-4b74-8f88-f44da8448171"),
                            Order = (short)0,
                            TemplateId = 2,
                            Type = 0
                        });
            ...
            modelBuilder.Entity("MasterCRM.Domain.Entities.Websites.TextBlock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a4e9e167-4fe0-4401-bb18-03658cf80840"),
                            Order = (short)2,
                            TemplateId = 1,
                        ...
                        new
                        {
                            Id = new Guid("aa499910-7a6d-4413-a8a1-442a17758766"),
                            Order = (short)2,
                            TemplateId = 2,
                            Text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In gravida porta sem, sit amet lobortis nunc rutrum in. Ut at ex ut ante blandit gravida a eu nisl. Fusce a lacus ullamcorper, ultrices neque eu, cursus risus. Cras nisl purus, dignissim in efficitur quis, aliquam id odio. Suspendisse eu risus accumsan, iaculis augue id, porta elit. Fusce faucibus, erat vitae faucibus sagittis, dui dolor tincidunt urna, ut vulputate leo lorem ac eros. Aenean fermentum posuere mattis. Suspendisse scelerisque felis diam, sed ultrices ante luctus sed. Fusce posuere nunc a felis eleifend, et sollicitudin mi eleifend."
                        });
